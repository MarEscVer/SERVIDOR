...
public class LibroController {
    ...
    /*
     * HIBERNATE: framework de mapeo objeto-relacional. Implementa la especificación JPA y proporciona funcionalidades adicionales
     * JPA: especificación de JAVA que proporciona un estandar para el mapeo objeto-relaiconal. Se usa con la implementación Hibernate
     * para simplificar acceso y manipulación de datos con bbdd relacionales
     * SPRING DATA: proporciona facilidades para trabajar con datos. Permite implementar repositorios de datos de forma
     * sencilla y conssistente.
     */
}
